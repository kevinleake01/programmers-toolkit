...
wget http://www.linuxfromscratch.org/lfs/downloads/7.6-systemd/LFS-BOOK-7.6-systemd.tar.bz2
...
svn co svn://wiki.linuxfromscratch.org/alfs/jhalfs/tags/2.3.2 SVN-jhalfs-2.3.2
svn co svn://wiki.linuxfromscratch.org/alfs/jhalfs/trunk SVN-jhalfs-latest
wget http://linuxfromscratch.org/hints/downloads/hints.tar.bz2 -O LFS-Hints.tar.bz2
cd ../
...
svn co http://svn.exactcode.de/t2/tags/8.0/ SVN-T2-8.0
